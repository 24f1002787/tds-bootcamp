--- Before Day-3 ---
I already knew how to create virtual environments with venv and had used pip before.
--- 
...
- Learned that uv stores temp envs in a cache directory (~/.cache/uv)
- Understood pyproject.toml as the modern replacement for requirements.txt
---
 
--- Feedback (Suggestions for the TDS Team) ---
A comparison table between uv, pip, and conda would be a great reference to include in the materials.
---
