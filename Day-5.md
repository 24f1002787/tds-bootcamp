--- Before Day-5 ---
I already knew basic git commands like add, commit, and push, but had not used SSH keys or tags before.
--- 
...
- Learned the importance of atomic commits — one logical change per commit
- Understood how SSH keys work and why they are more secure than passwords
---
 
--- Feedback (Suggestions for the TDS Team) ---
The bootcamp was very well paced overall. Adding a section on resolving merge conflicts would make the Git day even more complete.
---
