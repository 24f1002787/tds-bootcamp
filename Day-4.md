--- Before Day-4 ---
I already knew basic HTTP concepts and had used APIs before with requests library.
--- 
...
- Learned about automatic OpenAPI schema generation in FastAPI
- Understood the difference between query params and path params in FastAPI routes
---
 
--- Feedback (Suggestions for the TDS Team) ---
It would be helpful to include a mini-project like building a simple notes API to tie all concepts together on Day 4.
---
